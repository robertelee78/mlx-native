...
const SHAPES: &[DecodeShape] = &[
    ...
    DecodeShape { label: "Q_sliding",  n: 4096, k: 2816, qtype: GgmlType::Q6_K, per_token: 24 },
    DecodeShape { label: "K_sliding",  n: 2048, k: 2816, qtype: GgmlType::Q6_K, per_token: 24 },
    ...
    DecodeShape { label: "K_global",   n: 2048, k: 2816, qtype: GgmlType::Q6_K, per_token: 6 },
    DecodeShape { label: "V_global",   n: 2048, k: 2816, qtype: GgmlType::Q6_K, per_token: 6 },
    DecodeShape { label: "O_global",   n: 2816, k: 4096, qtype: GgmlType::Q6_K, per_token: 6 },
