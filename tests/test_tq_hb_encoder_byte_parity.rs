...
fn bench_fa_vec_tq_hb_gemma_decode() {
    ...
    // ADR-028 iter-125: extended to qwen sliding_window=4096 + 8192 to
    // size Path D (FA reduce-kernel cap > 32) at long-context decode.
    for &kv_seq_len in &[64u32, 128u32, 256u32, 512u32, 1024u32, 1536u32, 4096u32, 8192u32] {
