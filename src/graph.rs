...
impl<'a> GraphSession<'a> {
    ...
    /// Gather GGML Q4_0 embedding rows directly into F32 activations.
    pub fn embedding_gather_q4_0(
        ...
        token_ids: &MlxBuffer,
        output: &MlxBuffer,
        params: &ops::embedding_q4_0::EmbeddingQ4_0Params,
    ) -> Result<()> {
        ops::embedding_q4_0::embedding_gather_q4_0(
            &mut self.encoder,
            registry,
            device,
            weight,
    ...
    /// Gather Q5_0 embedding rows directly from their native GGUF blocks.
    pub fn embedding_gather_q5_0(
        ...
        token_ids: &MlxBuffer,
        output: &MlxBuffer,
        params: &ops::embedding_q5_0::EmbeddingQ5_0Params,
    ) -> Result<()> {
        ops::embedding_q5_0::embedding_gather_q5_0(
            &mut self.encoder,
            registry,
            device,
            weight,
    ...
    pub fn embedding_gather_q8_0(
        ...
        token_ids: &MlxBuffer,
        output: &MlxBuffer,
        params: &ops::embedding_q8_0::EmbeddingQ8_0Params,
    ) -> Result<()> {
        ops::embedding_q8_0::embedding_gather_q8_0(
            &mut self.encoder,
            registry,
            device,
            weight,
