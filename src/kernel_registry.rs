...
impl KernelRegistry {
    ...
    pub fn new() -> Self {
        ...
        // ADR-034 task #93 cont. 24 — fused gate+up+silu_mul Q4_K (broader quant coverage).
        #[allow(non_snake_case)]
        let fused_gate_up_silu_q4_K_src: &'static str =
        ...
        #[allow(non_snake_case)]
        let fused_gate_up_silu_q6_K_src: &'static str =
            include_str!("shaders/fused_gate_up_silu_q6_K.metal");
        sources.insert(
            "kernel_fused_gate_up_silu_q6_K_f32".into(),
            fused_gate_up_silu_q6_K_src,
        );
        ...
        sources.insert(
            "deepseek_mxfp8_fake_quant_bf16".into(),
            deepseek_activation_quant_src,
        );
        sources.insert(
            "deepseek_hadamard_mxfp4_bf16".into(),
            deepseek_activation_quant_src,
        );
